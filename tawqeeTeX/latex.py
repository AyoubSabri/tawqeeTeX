#TODO: add header and logo plus information
#TODO: adapt style and font
#TODO: add vspaces and center table
#TODO: add comments and commit
#TODO: add languages to the code generation
...
geometry_options = {"tmargin": "3cm", "rmargin": "2cm", "lmargin": "2cm"}
...
with header.create(Foot("C")):      #NOTE: L and R footer are also available
    header.append("Generated with islamFrame - islamframe@gmail.com")
